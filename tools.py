...
def show_images_4(image1, image2, image3, image4, image1_exp="Image 1", image2_exp="Image 2", image3_exp="Image 3",
                  image4_exp="Image 4"):
...
def show_images_3(image1, image2, image3, image1_exp="Image 1", image2_exp="Image 2", image3_exp="Image 3"):
...
def show_images_2(image1, image2, image1_exp="Image 1", image2_exp="Image 2"):
...
def get_heatmap(bboxes, output_image):
    threshold = 1
...
def hog_test(car_image, notcar_image, pix_per_cell, cell_per_block, spatial_size):
    ...
    show_images_4(car_ch1, car_hog_image, notcar_ch1, notcar_hog_image, "Car ch 1", "Car ch 1 HOG", "Not Car ch 1",
                  "Not Car ch 1 HOG")
    show_images_4(car_ch1, car_ch1_features, notcar_ch1, notcar_ch1_features, "Car ch 1", "Car ch 1 features",
                  "Not Car ch 1",
                  "Not Car ch 1 features")
    show_images_4(car_ch2, car_ch2_features, notcar_ch2, notcar_ch2_features, "Car ch 2", "Car ch 2 features",
                  "Not Car ch 2",
                  "Not Car ch 2 features")
    show_images_4(car_ch3, car_ch3_features, notcar_ch3, notcar_ch3_features, "Car ch 3", "Car ch 3 features",
                  "Not Car ch 3",
                  "Not Car ch 3 features")


def svc_training(cars, no_cars, color_space, spatial_size, hist_bins, pix_per_cell, cell_per_block, hog_channel,
                 spatial_feat,
                 hist_feat, hog_feat):
...
def svc_test(svc, X_scaler, pix_per_cell, cell_per_block, spatial_size, hist_bins):
    ...
    output_image3, bboxes3 = apply_sliding_window(image3, svc, X_scaler, pix_per_cell, cell_per_block, spatial_size,
                                                  hist_bins)
    output_image4, bboxes4 = apply_sliding_window(image4, svc, X_scaler, pix_per_cell, cell_per_block, spatial_size,
                                                  hist_bins)
    output_image5, bboxes5 = apply_sliding_window(image5, svc, X_scaler, pix_per_cell, cell_per_block, spatial_size,
                                                  hist_bins)
    output_image6, bboxes6 = apply_sliding_window(image6, svc, X_scaler, pix_per_cell, cell_per_block, spatial_size,
                                                  hist_bins)
